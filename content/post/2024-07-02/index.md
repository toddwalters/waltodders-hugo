...
tags: ["advanced-ai", "ai", "ai-governance", "ai-optimization", "ai-reliability", "ai-security", "anthropic", "automation", "azure", "claude", "cloud-computing", "cyber-security", "data-science", "developer-experience", "ethical-ai", "enterprise-architecture", "fin-ops", "generative-ai", "github-repo", "gtp-4", "juypter-notebooks", "langchain", "llm", "machine-learning", "nlp", "openai", "personal-development", "projects", "python", "rag", "responsible-ai", "security", "social-media-and-collaboration", "visualization"]
---

Wow.  So it's be another long while, since I got around to creating another entry. This one is another link list, based what has caught my eye over the last month.  Can't say I have read them all.  Something I did decide to do based on having all of these articles, was to create a python script that would interact with the [Omnivore API](https://docs.omnivore.app/integrations/api.html) (the application I use to grab links and content I want to read later) to grab all the articles I have saved and send all of those to openAI to create a summary and suggest some tags.  I will eventually create a write-up for that project, but wanted to get this link list out first.  

## [The Blank Sheet Method: From Passive Reading to Active Learning](https://fs.blog/blank-sheet-method/)

**Site Name:** Farnam Street

**Summary:** The article introduces The Blank Sheet Method as a way to enhance reading comprehension through active learning. This method involves creating a blank sheet where you write down what you know about the subject before reading and then adding new information in a different color after each reading session. By visually building knowledge, correcting misconceptions, and reviewing the sheet regularly, this approach transforms passive reading into a more engaging and effective learning process.

**Tags:** *\#active-learning, \#reading-comprehension, \#note-taking, \#critical-thinking, \#knowledge-retention*

## [Networking capabilities optimize traffic for generative AI apps | Google Cloud Blog](https://cloud.google.com/blog/products/networking/networking-capabilities-optimize-traffic-for-generative-ai-apps)

**Site Name:** Google Cloud
...
## [The Modern Architect - Gregor Hohpe's Videos](https://www.youtube.com/playlist?list=PLsuboX68NN3DL-sYP16NRyaLFRvSexa_s)
...
**Site Name:** Blog - Private Cloud Compute: A new frontier for AI privacy in the cloud - Apple Security Research
...
## [Deploying A GPT-4o Model to Azure OpenAI Service - Trailhead Technology Partners](https://trailheadtechnology.com/deploying-a-gpt-4o-model-to-azure-openai-service/)
...
## [Why are most LLMs decoder-only?. Dive into the rabbit hole of recent… | by Yumo Bai | Medium](https://medium.com/@yumo-bai/why-are-most-llms-decoder-only-590c903e4789)
...
## [Data store decision tree - Azure Application Architecture Guide | Microsoft Learn](https://learn.microsoft.com/en-us/azure/architecture/guide/technology-choices/data-store-decision-tree)
...
## [Infrastructure as Code Landscape Overview 2024 | by Brian Grant | Jun, 2024 | ITNEXT](https://itnext.io/infrastructure-as-code-landscape-overview-2024-a066124e5989?gi=56ad127a9ee8)

**Site Name:** ITNEXT

**Description:** After my previous post in my Infrastructure as Code and Declarative Configuration series, I thought I’d take a look at the Infrastructure as Code (IaC) landscape to see how it is evolving.

**Summary:** The article provides an overview of the evolving landscape of Infrastructure as Code (IaC) tools, categorizing them into various subgroups based on their functionalities and features. The author discusses core resource CRUD tools, CLI-based IaC orchestrators, developer scaffolding and deployment CLIs, IaC automation and cloud management platforms, and more, highlighting both well-known and newer tools. The article also touches on trends like AI-driven tools, asset management-focused tools, blast radius analysis, Ia
...
**Summary:** The site provides, blog articles, guides, and eBooks focused on learninga about machine learning 
...
## [Building a Platform Team at a 153-Year-Old Company - The New Stack](https://thenewstack.io/building-a-platform-team-at-a-153-year-old-company/)
...
## [Build Rag With Llamaindex To Make LLM Answer About Yourself, Like in an Interview or About General Information | by Lakshmi Narayana Santha | May, 2024 | Towards AI](https://pub.towardsai.net/build-rag-with-llamaindex-to-make-llm-answer-about-yourself-like-in-interview-or-about-general-68bb2037f8b6?gi=d379a686b47c)

**Site Name:** Towards AI
...
## [Is your AI workload secure?. In the not-so-distant past, when AI was… | by Sita Lakshmi Sangameswaran | Google Cloud - Community | Jun, 2024 | Medium](https://medium.com/google-cloud/is-your-ai-workload-secure-c57189b4e6d1)

**Site Name:** Google Cloud - Community
...
1. In the past, AI workflows were simpler with basic version control, but advancements like MLOps tools have improved organization and management of models. With the explosion of GenAI, the complexity and scale of AI deployments have increased, leading to new vulnerabilities and threats that exploit AI models.

2. Threats in the GenAI era range from jailbreaking to data poisoning, impacting confidentiality, integrity, and availability of AI assets. To address these concerns, a robust AI framework should incorporate secure-by
...
**Description:** Claude Engineer is an interactive command-line interface (CLI) that leverages the power of Anthropic&#39;s Claude-3.5-Sonnet model to assist with software development tasks. This tool combines ...
...
## [Build your own Large Language Model (LLM) From Scratch Using PyTorch | by Milan Tamang | Jun, 2024 | Towards AI](https://pub.towardsai.net/build-your-own-large-language-model-llm-from-scratch-using-pytorch-9e9945c24858?gi=a3b1cede2202)
...
**Summary:** The article discusses how AI technologies are impacting various industries, with a shift towards considering the interface of AI tools as crucial for user adoption. It highlights the abundance of AI models available, focusing on the rise of medium and small-sized models despite the attention given to large models. The article also explores the resurgence of interest in on-premises hardware for AI implementations due to concerns about data security and trust in cloud providers, emphasizing the complex considerations involved in AI adoption beyond just features and capabilities.
...
**Site Name:** writings.stephenwolfram.com
...
## [I Will Fucking Piledrive You If You Mention AI Again — Ludicity](https://ludic.mataroa.blog/blog/i-will-fucking-piledrive-you-if-you-mention-ai-again/?ck_subscriber_id=512830397)
...
**Description:** Enlarge / Zork running on an Amiga at the Computerspielemuseum in Berlin, Germany.

**Summary:** The history of interactive fiction (IF) stretches back over 50 years, beginning with the text-based game _Colossal Cave Adventure_ on a PDP-10 mainframe in the 1970s. IF evolved through significant contributions from communities on Usenet, pivotal innovations like Inform, and influential companies like Infocom, known for _Zork_. Despite technological advancements and the rise of AAA games, the IF community remains resilient and creative, bolstered by open-source tools like Twine and Ink,
